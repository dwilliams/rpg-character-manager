...
class TestItemFactoryDataLoad(unittest.TestCase):
    def setUp(self):
        ...
        self.test_item_names = []
        for test_item_data in TEST_ITEM_LIST:
            self.test_item_names.append(test_item_data['data']['item_name'])
    ...
    def test_create_factory_and_load_data(self):
        ...
        tmp_names = item_factory.get_list_names('none')
        self.assertListEqual(tmp_names, self.test_item_names)
